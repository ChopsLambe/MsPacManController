...
import pacman.controllers.OurController;
...
{	
	...
	public static void main(String[] args)
	{
		...
		System.out.println("OUR CONTROLLER VS Starter Ghosts");
		//exec.runGame(new OurController(),new StarterGhosts(), visual, delay);
